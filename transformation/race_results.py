...
# DBTITLE 1,Load required dataframes from processed container
...
# DBTITLE 1,Select required columns and add created_date column
...
# DBTITLE 1,Write to presentation layer
